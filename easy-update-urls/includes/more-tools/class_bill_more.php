<?php // namespace easy_update_urls_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "easy_update_urls_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class easy_update_urls_Bill_Minozzi_Add_Ajax_Url
{
...
$easy_update_urls_bill_minozzi_add_ajax_url = new easy_update_urls_Bill_Minozzi_Add_Ajax_Url();
class easy_update_urls_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\easy_update_urls_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\easy_update_urls_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new easy_update_urls_Bill_show_more_plugins();
// } // end namespace
class easy_update_urls_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \easy_update_urls_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new easy_update_urls_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class easy_update_urls_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new easy_update_urls_bill_install_QuietSkin();
