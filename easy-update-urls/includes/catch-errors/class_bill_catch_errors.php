...
namespace easy_update_urls_BillCatchErrors;
// created 06/23/23
...
/*
    if (function_exists('is_plugin_active')){
        $bill_plugins_to_check = array(
            'easy_update_urls/easy_update_urls.php',  
        );
...
function bill_install_mu_plugin()
{
    ...
    $easy_update_urls_mu_plugin_dir = WP_PLUGIN_DIR . '/easy-update-urls/includes/mu-plugins'; // Current path inside easy_update_urls
    ...
    try {
        ...
        // Define the plugin file path in the easy_update_urls directory
        $source = $easy_update_urls_mu_plugin_dir . '/' . $plugin_file;
...
add_action("wp_ajax_bill_minozzi_js_error_catched", "easy_update_urls_BillCatchErrors\\bill_minozzi_js_error_catched");
add_action("wp_ajax_nopriv_bill_minozzi_js_error_catched", "easy_update_urls_BillCatchErrors\\bill_minozzi_js_error_catched");
...
class easy_update_urls_bill_catch_errors
{
...
new easy_update_urls_bill_catch_errors();
//
