<?php namespace easy_update_urls_BillInstall;
//
/**
 * @ Author: Bill Minozzi
...
use easy_update_urls_BillDiagnose\MemoryChecker;
use easy_update_urls_BillDiagnose\ErrorChecker;
// ------------------------- Ago 24 -------------------- 

  if (!class_exists('easy_update_urls_BillDiagnose\MemoryChecker')) {
      return;
  }
    ...
    public function pre_checkup_page_content()
    {
        ...
        switch ($step) { case 1: ?> 
                <div class="bill_install_wrap">
                    ...
                    $diagnose_instance = new easy_update_urls_Bill_Class_Plugins_Install(
...
$plugin_install = new easy_update_urls_Bill_Class_Plugins_Install(
    $plugin_slug,
    $notification_url,
    $notification_url2,
    $plugin_text_domain,
