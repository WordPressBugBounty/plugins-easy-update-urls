...
class MemoryChecker
{
    public function check_memory()
    {
        try {
            ...
            // Check if easy_update_urls_LIMIT is defined
            if (!defined("WP_MEMORY_LIMIT")) {
                $wpmemory["wp_limit"] = 40; // Default value of 40M
            } else {
                $easy_update_urls_limit = WP_MEMORY_LIMIT;
                $wpmemory["wp_limit"] = (int) $easy_update_urls_limit;
            }
    ...
    public function site_health_tab_content($tab)
    {
        ...
        <div class="wrap health-check-body, privacy-settings-body">
            ...
            <div id="chat-box">
                ...
                <form id="chat-form">
                    ...
                    <div id="action-instruction" style="text-align: center; margin-top: 10px;">
                        <span><?php echo esc_attr__("Enter a message and click 'Send', or just click 'Auto Checkup' to analyze error log ou server info configuration.", 'easy-update-urls'); ?></span>
                    </div>
            ...
            if ($average > 5) {
                ...
                echo '</strong>';
                echo esc_html__("Block bots: They overload the server and steal your content. Install our free plugin StopBadBots.", "easy-update-urls") . '<br>';
