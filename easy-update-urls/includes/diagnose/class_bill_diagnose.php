            ...
            <div id="chat-box">
                ...
                <form id="chat-form">
                    ...
                    <div id="action-instruction" style="text-align: center; margin-top: 10px;">
                        <span><?php echo esc_attr__("Enter a message and click 'Send', or just click 'Auto Checkup' to analyze the site's error log.", 'easy-update-urls'); ?></span>
                    </div>
                    <div class="auto-checkup-container" style="text-align: center; margin-top: 10px;">
                        <button type="button" id="auto-checkup">
                            ...
                            <?php echo esc_attr__('Auto Checkup', 'easy-update-urls'); ?>
                        </button>
                    </div>
                </form>
            </div>
